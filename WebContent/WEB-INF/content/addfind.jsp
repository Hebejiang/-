	...
	<div id="templatemo_wrapper_sp">
		...
		<div id="templatemo_main_wrapper">
			<div id="templatemo_main">
				...
				<form action="addfinddetail" enctype="multipart/form-data"method="post">
				
				
				标题<input  type="text" Name="findtitle" id="findtitle" /></br><br>
				...
				<br><br>详细情况<input name="finddetail" id="finddetail" type="text" style="width:200px; height:200px;" /><br><br>
