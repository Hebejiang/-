			...
			<div id="templatemo_main">
				...
				<div id="content" class="right">
					...
					<h2>详细信息</h2>
						...
						<h2 id="findid" style="visibility: hidden;">${find.getFindid()}</h2>
					<div class="content_half left">
						<h2 id="findtitle">${find.getFindtitle()}</h2>
						<a rel="lightbox" href="<%=basePath%>${find.getFindphoto()}"><img
							src="<%=basePath%>${find.getFindphoto()}" height="165" width="165"/></a>
						<h4 style="margin-top: 20px;">详情</h4>
						<p>${find.getFinddetail()}.</p>
					</div>
						...
						<div class="content_half right">
							<table id="flowertable">
								<tr>
									<td width="130">种类:</td>
									<td width="84" id="type">${find.getType()}</td>
								</tr>
								<tr>
									<td>发布人:</td>
									<td><strong>${fuser.getLoginname() }</strong></td>
								</tr>
								<tr>
								<td>联系电话:</td>
									<td><strong>${fuser.getPhonenumber() }</strong></td>
								</tr>
								<tr>
								<td>邮箱:</td>
									<td><strong>${fuser.getMailbox() }</strong></td>
								</tr>
					<c:choose>
