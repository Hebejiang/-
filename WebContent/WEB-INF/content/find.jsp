			...
			<div id="templatemo_header" class="header_subpage">
				...
				<div id="templatemo_menu" class="ddsmoothmenu">
					<ul>
						...
						<li><a href="find" class="selected">失物招领</a></li>
		...
		<div id="templatemo_main_wrapper">
			<div id="templatemo_main">
					...
					<div class="sidebar_box">
						...
						<div class="content">
							<ul class="sidebar_list">
								...
								<li><a href="find">全部</a></li>
														
								<li><a href="findmune?type=1">一卡通</a></li>
								
								<li><a href="findmune?type=2">身份证</a></li>
								
								<li><a href="findmune?type=3">银行卡</a></li>
								
								<li><a href="findmune?type=4">水卡</a></li>
								
								<li><a href="findmune?type=5">手机</a></li>
								
								<li><a href="findmune?type=6">钱包</a></li>
								
								<li><a href="findmune?type=7">书包</a></li>
								
								<li><a href="findmune?type=8">其他</a></li>
							</ul>
						</div>
					</div>
				...
				<div id="content" class="right">
					...
					<c:forEach items="${flt}" var="find">
				
						<div class="product_box">
							<a
								href="finddetail?findid=${find.getFindid() }"><img
							...
							<p class="add_to_cart">
								<a
									href="finddetail?findid=${find.getFindid()}">详情</a>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br>
	<div class="blank_box">
		...
		<a class="button left" href="find?pageNow=1">首页</a>
		<c:choose>
			
			<c:when test="${page.pageNow - 1 > 0}">
				<a class="button left" href="find?pageNow=${page.pageNow - 1}">上一页</a>
			</c:when>
			<c:when test="${page.pageNow - 1 <= 0}">
				<a class="button left" href="find?pageNow=1">上一页</a>
			</c:when>
		</c:choose>
		...
		<c:choose>
			<c:when test="${page.totalPageCount==0}">
				<a class="button right" href="find?pageNow=${page.pageNow}">尾页</a>
			</c:when>
			<c:otherwise>
				<a class="button right" href="find?pageNow=${page.totalPageCount}">尾页</a>
			</c:otherwise>
		</c:choose>
			<c:choose>
			<c:when test="${page.totalPageCount==0}">
				<a class="button right" href="find?pageNow=${page.pageNow}">下一页</a>
			</c:when>
			<c:when test="${page.pageNow + 1 < page.totalPageCount}">
				<a class="button right" href="find?pageNow=${page.pageNow + 1}">下一页</a>
			</c:when>
			<c:when test="${page.pageNow + 1 >= page.totalPageCount}">
				<a class="button right" href="find?pageNow=${page.totalPageCount}">下一页</a>
			</c:when>
		</c:choose>
